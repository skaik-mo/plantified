...
import imgDesignReference from '../assets/images/img_design_reference.svg';
  ...
  return (
    <section id="home" className="relative w-full min-h-[709px] bg-[#FCF7F2] overflow-hidden flex items-center justify-between box-border">
      <img
        ...
        alt="Horizontal leaf decoration"
      />

      <div className="pl-[64px] pr-8 py-12 md:py-20 max-w-[620px] z-10 flex flex-col justify-center relative">
        ...
        <div className={`flex flex-row items-center space-x-4 mt-0 reveal-hidden ${animate ? 'reveal-visible' : ''} delay-[400ms]`}>
          <PrimaryButton
          ...
          />
          <div
            className="px-[32px] bg-transparent hover:bg-[#346E3C]/8 text-[#346E3C] font-medium text-[16px] border border-[#000000]/8 rounded-[100px] text-center flex items-center justify-center cursor-pointer h-[48px] box-border transition-all duration-300"
            id="hero-care-cta"
          >
            <span>Explore</span>
          </div>
      ...
      <div className={`absolute right-0 top-0 h-[709px] w-[669px] z-0 flex items-start justify-end reveal-hidden ${animate ? 'reveal-visible' : ''} delay-[200ms]`}>
        <img
          src={imgDesignReference}
          className="h-[709px] w-[669px] object-cover pointer-events-none select-none"
          alt="Hand holding monstera"
        />
      </div>
    </section>
  );
